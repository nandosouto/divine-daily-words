...
const DownsellPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-beige-100 font-montserrat">
      ...
      <div className="relative w-full h-[300px] md:h-[400px] bg-gradient-to-b from-beige-200 to-beige-100 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://images.unsplash.com/photo-1518495973542-4542c06a5843?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80')] bg-cover bg-center"></div>
        <div className="absolute inset-0 bg-beige-100 bg-opacity-30"></div>
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
          <div className="mb-6 p-4 bg-white bg-opacity-80 rounded-full shadow-md">
            <Book size={48} className="text-softBlue-500" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">
            Palavra Diária
          </h1>
          <p className="text-lg md:text-xl text-gray-600">Sua conexão diária com a sabedoria divina</p>
        </div>
      </div>
      ...
      <div className="container max-w-5xl mx-auto px-4 py-8 md:py-12">
        ...
        <Card className="p-6 md:p-8 mb-8 bg-white shadow-lg border-gold-300 border">
          <div className="text-center mb-6">
            ...
            <a href="https://pay.cakto.com.br/ns4fk9q" target="_blank" rel="noopener noreferrer">
              <Button className="bg-softBlue-500 hover:bg-softBlue-600 text-white py-3 px-6 rounded-md text-lg animate-pulse-glow shadow-lg">
        ...
        <div className="bg-beige-200 p-6 rounded-lg mb-12">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <div className="md:w-1/4 flex justify-center">
              <Book size={120} className="text-gold-500" strokeWidth={1} />
            </div>
        ...
        {/* Bloco 4 - O que você vai ganhar */}
        <div className="mb-12">
          <h3 className="text-xl md:text-2xl font-semibold text-gray-800 text-center mb-8">
            O que você vai ganhar:
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="p-6 text-center bg-white hover:shadow-md transition-shadow">
              <div className="h-12 flex items-center justify-center mb-4">
                <CircleArrowRight size={40} className="text-gold-500" />
              </div>
              <h4 className="font-bold text-lg mb-2">Versículos Personalizados</h4>
              <p className="text-gray-600">Geração diária de versículos personalizados para sua vida</p>
            </Card>
            ...
            <Card className="p-6 text-center bg-white hover:shadow-md transition-shadow">
              ...
              <h4 className="font-bold text-lg mb-2">Desenvolvimento Espiritual</h4>
              <p className="text-gray-600">Desenvolvimento espiritual contínuo com reflexões diárias</p>
            </Card>
            ...
            <Card className="p-6 text-center bg-white hover:shadow-md transition-shadow">
              ...
              <h4 className="font-bold text-lg mb-2">Sempre Disponível</h4>
              <p className="text-gray-600">Fácil de usar e sempre disponível na palma da sua mão</p>
            </Card>
          </div>
        </div>

        {/* Bloco 5 - Elementos de urgência */}
        <Card className="p-6 bg-gold-100 border-gold-300 border mb-12">
          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-800 mb-4">⏰ ATENÇÃO!</h3>
        ...
        {/* Bloco 7 - Chamada para ação final */}
        <div className="text-center mb-12 py-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a href="https://pay.cakto.com.br/ns4fk9q" target="_blank" rel="noopener noreferrer" className="mb-4 md:mb-0">
              <Button className="bg-softBlue-500 hover:bg-softBlue-600 text-white py-3 px-6 rounded-md text-lg w-full md:w-auto">
        ...
        {/* Footer */}
        <div className="border-t border-beige-300 pt-6 text-center text-sm text-gray-500">
